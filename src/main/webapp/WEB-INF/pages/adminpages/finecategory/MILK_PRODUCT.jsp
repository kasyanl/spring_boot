...
<table class="title" align="right">
    <tr>
        <th>
            <a href="${pageContext.request.contextPath}/product/categorydiscount/MILK_PRODUCT" title="Изменить скидку для категории">
        ...
        <th>
            <a href="${pageContext.request.contextPath}/product/exportexcel/MILK_PRODUCT" title="Экспорт в Excel файл">
