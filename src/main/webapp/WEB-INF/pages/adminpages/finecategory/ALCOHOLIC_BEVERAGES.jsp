...
<table class="title" align="right">
    <tr>
        <th>
            <a href="${pageContext.request.contextPath}/product/categorydiscount/ALCOHOLIC_BEVERAGES" title="Изменить скидку для категории">
        ...
        <th>
            <a href="${pageContext.request.contextPath}/product/exportexcel/ALCOHOLIC_BEVERAGES" title="Экспорт в Excel файл">
