...
<h2>Установите новую единую скидку для категории VEGETABLES:</h2>
<form action="${pageContext.request.contextPath}/product/categorydiscount/VEGETABLES" method="post">
    Новая скидка:<br>
