...
<h2>Установите новую единую скидку для категории MILK_PRODUCT:</h2>
<form action="${pageContext.request.contextPath}/product/categorydiscount/MILK_PRODUCT" method="post">
    Новая скидка:<br>
